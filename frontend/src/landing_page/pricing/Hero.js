...
function Hero() {
    return (
        <div className='container ao-pricing-page'>
          <div className='row text-center mt-5'>
            <h1 className='mt-5' style={{ background: 'linear-gradient(135deg, #7C3AED, #6366f1, #818cf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Charges</h1>
            <p style={{fontSize:"1.2rem", color: '#9a9ab0'}} className='mb-5'>List of all charges and taxes</p>
          </div>

          <div className='row'>
            <div className='col-4 p-4 mt-4'>
              <div className='ao-pricing-card'>
