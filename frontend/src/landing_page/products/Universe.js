  ...
  return (
    <div className="container np-universe mt-5 mb-5">
      <div className="row text-center">
        <h1 className="mt-5 mb-4 display-6" style={{ fontWeight: 800 }}>The NovaPulse Universe</h1>
        ...
        <div className="row g-4 mt-2">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="np-card h-100">
              <img src="\media\arthaodhaFundhouse.png" className="mb-4" height="45" alt="NovaPulse Fundhouse" />
              <p className="small text-muted">
